<template>
  ...
  <ChartAtmosphericHero>
    ...
    <section class="chart-skeleton" aria-busy="true" aria-label="Загрузка натальной карты">

      <div class="chart-skeleton__meta chart-skeleton__shimmer" />



      <div class="chart-skeleton__wheel chart-skeleton__shimmer" aria-hidden="true" />

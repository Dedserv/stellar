    ...
    <div class="questionnaire__wrapper container layout-upper">
      <div class="questionnaire__text-wrapper">
        ...
        <p class="questionnaire__text">
          Звёзды знают о вас больше, чем вы думаете. Пройдите короткий тест и узнайте свой
          астрологический архетип — с портретом личности, балансом стихий и персональным советом.
        </p>
        <VButton

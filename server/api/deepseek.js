...
Абзацы строго 340-560 символов. Каждый абзац начинается с #. Ключевые термины ВСЕГДА выделяй ^с двух сторон^ (без **). Заголовок ТОЛЬКО через * без цифр/двоеточий. Не предлагай продолжение диалога.`,
...
Абзацы строго 340-560 символов. Каждый абзац начинается с #. Ключевые термины (рекомендации, инструмент самопознания и т.д.) ВСЕГДА в ^ (без **). Заголовок ТОЛЬКО через *. Это последний блок — никаких предложений о продолжении.`,
};

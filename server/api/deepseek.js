...
* Основы натальной карты
   # Начни с ^Солнце в [знак]^ — дай развернутое объяснение (340-560 символов). Затем ^Луна в [знак]^ — подробная интерпретация. Заверши ^Асцендент в [знак]^ — анализ первого впечатления.
...
Абзацы строго 340-560 символов. Каждый абзац начинается с #. Ключевые термины ВСЕГДА выделяй ^с двух сторон^ (без **). Заголовок ТОЛЬКО через * без цифр/двоеточий. Не предлагай продолжение диалога. При ответе учитывай, что сейчас 2025 год.`,
...
Абзацы строго 340-560 символов. Каждый абзац начинается с #. Ключевые термины (рекомендации, инструмент самопознания и т.д.) ВСЕГДА в ^ (без **). Заголовок ТОЛЬКО через *. При ответе учитывай, что сейчас 2025 год. Это последний блок — никаких предложений о продолжении.`,
};
